...
![Lebai Simulator Dashboard](./lebai/lebai_simulator_dashboard.png)
...
For complete source code, see: [dora-examples/lebai](https://github.com/dora-rs/dora-examples/tree/main/examples/lebai)
