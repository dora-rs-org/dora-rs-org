...
1. **Version mismatch** - The dora-rs Python package version must match dora-cli:
   ...
   pip install dora-rs==<version>  # Match your CLI version
   ```
...
Full source code: [dora-examples/franka](https://github.com/dora-rs/dora-examples/tree/main/examples/franka)
